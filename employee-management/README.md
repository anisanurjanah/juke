...
Frontend (React App): https://employee-management-gilt-alpha.vercel.app/
Backend (JSON Server): https://juke-backend.onrender.com (Free plan)

Jika backend Render offline, aplikasi akan otomatis fallback ke Typicode untuk GET /employees.
